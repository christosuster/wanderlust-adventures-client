    ...
    <div className="signin-page">
      ...
      >
        ...
        <div className="mx-auto text-center">
          ...
          <button type="submit" className="btn btn-primary text-center mx-auto">
            Submit
          </button>
        </div>
        <div className="pt-5 text-center">
          <button onClick={handleLogin} className="btn btn-danger">
            <i className="fa-brands fa-google text-white px-3"></i> Sign In with{" "}
            <span className="text-white fw-bold">Google</span>
          </button>
        </div>
      </form>
    </div>
